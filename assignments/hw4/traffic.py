...
Name : Belinda Trinh
traffic.py
Problem: This program calculates the average of vehicles that travel each road for each day.
...
def main():
    ...
    for road in range(1, number_of_roads + 1):
        number_of_days = eval(input(" how many days was road "+str(road) + " surveyed ?"))
        acc = 0
